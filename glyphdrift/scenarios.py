...
SCENARIOS: dict[str, GlyphDriftConfig] = {
    ...
    # ── v7 scenarios: Hieroglyphic Alphabet ──────────────────────────────
    "v7_hiero_80": GlyphDriftConfig(
        population_size=100,
        sequence_length=10,
        generations=1000,
        entropy=0.5,
    ...
    "v7_hiero_40": GlyphDriftConfig(
        ...
        use_sliding_window=True,
        track_grammar=True,
        alphabet_name="hieroglyphic_40",
    ),
    "v7_alch_vs_hiero": GlyphDriftConfig(
        population_size=100,
        sequence_length=10,
        generations=1000,
        entropy=0.5,
        ...
        use_sliding_window=True,
        track_grammar=True,
        alphabet_name="alchemical",  # Same params as hiero_40, different symbols
    ),
}
